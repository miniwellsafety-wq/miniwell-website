...
//                         {/* Label */}
//                         <div className="flex items-center gap-2 text-[#f47629] font-bold uppercase tracking-widest text-xs mb-6">
...
//                                 <div className="w-25 h-25 rounded-full border border-[#f47629] flex items-center justify-center text-2xl font-extrabold shadow-sm bg-[#fdfaf5]">
//                                     <div className="w-20 h-20 rounded-full  flex items-center justify-center text-2xl font-extrabold  bg-yellow-50">
//                                         98%
//                                     </div> </div>
...
//                                 <div className="mt-1 bg-[#f47629] text-white rounded-full p-0.5 shrink-0">
...
//                     {/* Right Column: Image */}
//                     <div className="relative w-full h-[500px] lg:h-[650px] rounded-3xl overflow-hidden shadow-lg">
//                         {/* Note: Update the src below with your actual project image path */}
//                         <img
//                             src="https://images.unsplash.com/photo-1605806616949-1e87b487cb2a?q=80&w=2070&auto=format&fit=crop"
//                             alt="Firefighter fully geared up with a massive fire in the background"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="relative w-full h-[500px] lg:h-[650px] rounded-3xl overflow-hidden shadow-lg border border-gray-100">
                        {/* Swapped standard <img> for Next.js <Image /> */}
                 <Image
                   src="/model3.png" // Path relative to the public folder
