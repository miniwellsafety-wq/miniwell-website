...
// //           <div className="relative w-full max-w-md mx-auto lg:mx-0 lg:max-w-none pl-8 lg:pl-16">

// //             {/* Rotated Vertical Text */}
// //             <div className="absolute top-1/2 left-0 lg:left-4 -translate-y-1/2 -rotate-90 origin-center text-xs font-bold text-gray-700 tracking-[0.2em] whitespace-nowrap hidden md:block">
// //               5200+ FIVE STAR REVIEWS
// //             </div>

// //             {/* Main Image - sharp bottom-right corner */}
// //             <div
...
// //             >
// //               <img
// //                 src="https://picsum.photos/seed/main/800/1000"
// //                 alt="Main presentation"
// //                 className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
// //               />
// //               {/* Shine effect only on main image */}
// //               <div className="absolute inset-0 z-20 pointer-events-none " />
// //             </div>

// //             {/* Floating Orange Badge (Top Left) */}
// //             <div className="absolute top-12 -left-4 sm:-left-8 bg-[#f47629] text-white rounded-[1.5rem] p-6 w-36 h-36 sm:w-40 sm:h-40 flex flex-col justify-center items-center shadow-lg text-center z-10">
// //               <Award className="w-10 h-10 mb-2" strokeWidth={1.5} />
// //               <span className="font-bold text-base sm:text-lg leading-tight">
// //                 30 + years of<br />experience
// //               </span>
// //             </div>

// //             {/* Secondary Image - sits exactly at bottom-right sharp corner */}
// //             <div
// //               className="absolute z-10 hidden md:block overflow-hidden border-[10px] border-[#fcfbf8]"
// //               style={{
// //                 width: '55%',
// //                 aspectRatio: '1/1',
// //                 bottom: '-6%',
...
// //             >
// //               <img
// //                 src="https://picsum.photos/seed/secondary/400/400"
// //                 alt="Secondary presentation"
...
// //             {/* Subheading */}
// //             <div className="flex items-center gap-2 text-[#f47629] font-bold uppercase tracking-widest text-sm">
...
// //                 <CheckCircle2 className="text-white fill-[#f47629] w-6 h-6 shrink-0" />
...
// //                   Join our <strong className="text-[#291507]">5000+</strong> satisfied client
// //                 </div>
// //               </div>

// //               {/* 24x7 Response */}
// //               <div className="flex items-center gap-4">
// //                 <div className="w-12 h-12 bg-[#f47629] rounded-full flex items-center justify-center text-white shrink-0 shadow-md">
...
// //             {/* CTA Button */}
// //             <div className="pt-6">
// //               <button className="inline-flex items-center bg-[#f47629] hover:bg-orange-600 text-white font-semibold rounded-full pl-6 pr-2 py-2 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
// //                 <span>More About Us</span>
// //                 <div className="ml-4 w-8 h-8 bg-white rounded-full flex items-center justify-center text-[#f47629]">
...
//             <div className="absolute top-120 left-50 right-[600%] lg:left-10 -translate-y-1/2 -rotate-90 origin-center text-xs font-bold text-gray-700 tracking-[0.2em] whitespace-nowrap hidden md:block">
...
//             <div className="absolute top-12 -left-4 sm:-left-8 bg-[#BE0201] text-white rounded-[1.5rem] p-6 w-36 h-36 sm:w-40 sm:h-40 flex flex-col justify-center items-center shadow-lg text-center z-10">
//               <Award className="w-10 h-10 mb-2" strokeWidth={1.5} />
//               <span className="font-bold text-base sm:text-lg leading-tight">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative w-full max-w-md mx-auto lg:mx-0 lg:max-w-none pl-8 lg:pl-16 mt-8 lg:mt-0">
            ...
            {/* FIX 1: Removed 'hidden md:block' and fixed the mobile positioning so it fits nicely on the left edge */}
            {/* <div className="absolute top-120 left-[80%] right-[500%]  sm:-left-[80%] sm:-right-[500%] lg:left-20 -translate-y-1/2 -rotate-90 origin-center text-[10px] sm:text-xs font-bold text-gray-700 tracking-[0.2em] whitespace-nowrap z-20">
              50+ FIVE STAR REVIEWS
            </div> */}
            ...
            {/* FIX 2: Removed 'hidden md:block' and made the border slightly thinner on mobile (border-[6px]) so it doesn't overwhelm the image */}
            <div
